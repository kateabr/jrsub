...
class MyTestCase(unittest.TestCase):
    ...
    def test_readings_lexemes(self):
        ...
        self.assertEqual(
            self.wd.lookup_translations_only("鳳輦"),
            [
                "《кн.》 колесница с золотой птицей «хо» на крыше",
                "《кн.》 императорский экипаж",
            ],
        )
        self.assertEqual(
        ...
        self.assertEqual(
            self.wd.lookup_translations_only("明六つ"),
        ...
        self.assertEqual(
            self.wd.lookup_translations_only("靄々"),
            [
        ...
        self.assertEqual(
            self.wd.lookup_translations_only("補助"),
            [
        ...
        self.assertEqual(
            self.wd.lookup_translations_only("約する"),
            [
                "сокращать 《дробь》",
                "договориться, заключить " "договор (контракт)",
                "обещать",
                "сокращать; опускать",
                "захватывать",
            ],
        ...
        self.assertEqual(
            self.wd.lookup_translations_only("旅慣れる"),
            [
                "＿≪-ta≫ привыкший путешествовать",
                "＿≪-nai≫ " "непривычный к " "путешествиям",
            ],
        )
        self.assertEqual(
            self.wd.lookup_translations_only("坊主"),
            [
                "《буд.》 монах; 《обр.》 бритоголовый",
                "〈~ni naru〉 " "постричься [в" " монахи]",
                "〈~ni naru〉, 〈~ni karu 【刈る】〉 《обр.》 коротко "
                "остричься, обрить голову",
            ],
        )
        self.assertEqual(
            self.wd.lookup_translations_only("干し海苔"),
            [
                "нори 《тонкие листочки сушеной водоросли tenera, употребляются как приправа》"
            ],
        )
        self.assertEqual(
            self.wd.lookup_translations_only("乾し物"), ["что-либо высушенное на солнце"]
        )
        self.assertEqual(
            self.wd.lookup_translations_only("ほじくり出す"),
            [
        ...
        self.assertEqual(
            self.wd.lookup_translations_only("保する"),
            ["《кн.》 гарантировать, обеспечивать"],
        )
        self.assertEqual(
            self.wd.lookup_translations_only("細腕"),
        ...
        self.assertEqual(
            self.wd.lookup_translations_only("ほんこ"),
            ["《прост.》 〈~de menko wo suru〉 играть в картинки " "《детская игра》"],
        )
        self.assertEqual(
            self.wd.lookup_translations_only("嫌味"),
            [
                "〈~no aru〉 неприятный; колкий; безвкусный",
                "〈~no nai〉 приятный; со вкусом",
            ],
        )
        self.assertEqual(
            self.wd.lookup_translations_only(lexeme="相", reading="あい"),
            ["взаимно, друг друга, обоюдно; " "вместе"],
        )
        self.assertEqual(
            self.wd.lookup_translations_only("青黄紛"), ["《смесь двух порошков》"]
        )
        self.assertEqual(
            self.wd.lookup_translations_only("五つ時"),
            ["《ист.》 «пять часов» 《время от 8 до 10 часов " "вечера и утра》"],
        )
        self.assertEqual(
            self.wd.lookup_translations_only("苺"), ["земляника, клубника", "малина"]
        )
        self.assertEqual(self.wd.lookup_translations_only("莓"), ["малина"])
        self.assertEqual(
            self.wd.lookup_translations_only("一年生"),
            [
                "первокурсник, первоклассник; 《обр.》 начинающий, " "новичок",
                "〈[~no]〉 однолетний 《о растениях》",
            ],
        )
        self.assertEqual(
            self.wd.lookup_translations_only("原水爆"),
            [
                "(《сокр.》 genshi 【原子】 bakudan 【爆弾】 + suiso 【水素】 "
                "bakudan 【爆弾】) атомная и водородная бомбы"
            ],
        )
        self.assertEqual(
            self.wd.lookup_translations_only("浮上げ彫"), ["барельеф, горельеф"]
        )
        self.assertCountEqual(
            self.wd.lookup_translations_only("未だ"),
            [
                "《кн.》 еще [не]",
                "с 《отриц.》 еще не",
                "[все] еще",
        ...
        self.assertEqual(
            self.wd.lookup_translations_only("新玉"),
            [
                "〈~no〉 《поэтическое определение к таким словам, "
                "как год, месяц и т. п.》",
                "неограненный " "драгоценный камень",
            ],
        )
        self.assertEqual(
            self.wd.lookup_translations_only("一元"),
            [
                "〈~no〉, 〈~teki〉 унифицированный; "
        ...
        self.assertEqual(
            self.wd.lookup_translations_only("一次"),
            [
                "〈~no〉 первый, первичный 《о повторяющихся явлениях》",
                "〈~no〉 《мат.》 первой степени",
            ],
        )
        self.assertEqual(
            self.wd.lookup_translations_only("正札付き"),
            [
                "〈~no〉 без запроса",
                "〈~no〉 《перен.》 отъявленный; " "заведомый 《напр. о " "мошеннике》",
            ],
        )
        self.assertEqual(
            self.wd.lookup_translations_only("入府"),
            [
                "〈~suru〉 въезжать в округ, въезжать в город",
                "〈~suru〉 《ист.》 въезжать в свое владение",
            ],
        )
        self.assertEqual(
            self.wd.lookup_translations_only("予算外"),
            [
                "〈~no〉 не предусмотренный в бюджете, не включенный "
                "в бюджет, внесметный",
                "〈~no〉 непредвиденный",
            ],
        )
        self.assertEqual(
            self.wd.lookup_translations_only("猥雑"),
            [
                "〈~na〉 неряшливый 《гл. обр. в одежде》",
                "〈~na〉 грубый, вульгарный, низкопробный",
            ],
        )

        self.assertCountEqual(
            self.wd.lookup_translations_only("側"),
            [
                "сторона, бок",
                "ряд, шеренга",
                "《связ.》 〈~[no mono 【者】]〉 окружающие",
                "сторона 《в переговорах, конфликтах и т. п.; " "часто не переводится》",
                "сторона",
        ...
        self.assertCountEqual(
            self.wd.lookup_translations_only("火照らす"),
            [
        ...
        self.assertCountEqual(
            self.wd.lookup_translations_only("骨節"), ["сустав", "суставы"]
        )
        self.assertCountEqual(
        ...
        self.assertCountEqual(
            self.wd.lookup_translations_only("後生大事"),
            [
                "〈~ni〉 с религиозным рвением",
        ...
        self.assertEqual(
            self.wd.lookup_translations_only("裏書譲渡"),
            ["〈~suru〉 делать передаточную надпись, индоссировать, жирировать"],
        )

        self.assertCountEqual(
            self.wd.lookup_translations_only("匹", "ひき"),
            [
                "《счетный суф. для животных》",
                "《после числит.》 хики 《мера измерения тканей = 21,2 м》",
                "《после числит.》 штука 《напр. шелка》",
                "= 2 тан = 21,2 м 《для измерения тканей》",
            ],
        )

        self.assertCountEqual(
            self.wd.lookup_translations_only("思わせる", "おもわせる"),
            [
        ...
        self.assertCountEqual(
            self.wd.lookup_translations_only("取れる", "とれる"),
            [
                "получаться 《о деньгах, плате》",
                "получаться, добываться",
                "ловиться",
                "получаться, выходить 《о снимке》",
        ...
        self.assertCountEqual(
            self.wd.lookup_translations_only("領域", "りょういき"),
            ["территория, владения; район", "《перен.》 область, сфера 《чего-л.》"],
        )

        self.assertCountEqual(
            self.wd.lookup_translations_only("起こさせる", "おこさせる"),
            [
        ...
        self.assertCountEqual(
            self.wd.lookup_translations_only("蛻け", "もぬけ"),
            [
                "линька 《животных》",
        ...
        self.assertCountEqual(
            self.wd.lookup_translations_only("七草", "ななくさ"),
            [
        ...
        self.assertCountEqual(
            self.wd.lookup_translations_only("働かす", "はたらかす"),
            [
        ...
        self.assertCountEqual(
            self.wd.lookup_translations_only("版籍", "はんせき"),
            ["(《сокр. от》 hanto 【版図】, koseki 【戸籍】) 《ист.》 страна и народ"],
        )

        self.assertCountEqual(
            self.wd.lookup_translations_only("風趣", "ふうしゅ"),
            ["《кн.》 вкус; прелесть 《чего-л.》; 〈~no nai〉 безвкусный", "《кн.》 тон, вид"],
        )

        self.assertCountEqual(
            self.wd.lookup_translations_only("見出す", "みいだす"),
            [
                "высмотреть, заметить, обнаружить, открыть",
                "высматривать, выискивать; отбирать, выбирать",
            ],
        )
        ...
        self.assertCountEqual(
            self.wd.lookup_translations_only("阿羅漢", "あらかん"),
            [
        ...
        self.assertCountEqual(
            self.wd.lookup_translations_only("軈て", "やがて"),
            [
                "скоро, вскоре; немного спустя",
                "почти",
                "〈~…de aru〉 《что-л.》 [есть] не что иное, как…",
            ],
        )
        self.assertCountEqual(
            self.wd.lookup_translations_only("敢えて", "あえて"),
            [
        ...
        self.assertCountEqual(
            self.wd.lookup_translations_only("処", "ところ"),
            [
                "《сущ.》 место; 〈…〉＿〈~ni aru〉 находиться 《где-л.》",
                "《сущ.》 [определенное] место",
                "《сущ.》 местожительство; 《чей-л.》 дом",
                "《сущ. перен.》 место, сторона; черты",
                "《сущ.》 кое-что, что-то; то что",
            ],
        )
        self.assertCountEqual(
            self.wd.lookup_translations_only("指揮", "しき"),
            [
        ...
        self.assertCountEqual(
            self.wd.lookup_translations_only("何処", "とこ"),
            [
                "где?; какое место?; в каком месте?",
                "〈~de〉, 〈~ni〉 где?",
                "〈~kara〉 откуда?",
                "〈~e〉 куда?",
                "〈~demo〉, 〈~ni mo〉 [по]всюду, везде; 《с отриц.》 нигде",
                "〈~…ka〉 где…?",
                "〈~ni ka〉 где-нибудь, где-то; кое-где",
            ],
        )

        self.assertEqual(
            self.wd.lookup_translations_only("亡き骸"),
